...
<section
    ...
    <p style="color: rgb(62, 62, 62);">
        <span style="font-size: 15px;">2019年5月27日—6月27日</span>
    </p>
    <p style="color: rgb(62, 62, 62);">
    ...
    <p style="color: rgb(62, 62, 62);">
                                                                                            <span style="font-size: 15px;">1、顾客在活动门店购买<span
                                                                                                    style="color: #FF0000;">仁和乳铁蛋白粉</span>即可参加爱心公益行活动。乳铁蛋白粉<strong><span
                                                                                                    style="color: #FF0000;">爱心公益价</span></strong>229元（<span
                                                                                                    style="color: #FF0000;">原价458元</span>），每人<span
                                                                                                    style="color: #FF0000;">限购3听</span>。</span>
    </p>
    <p style="color: rgb(62, 62, 62);">
                                                                                            <span style="font-size: 15px;">2、您每消费229元，仁和康健就<span
                                                                                                    style="color: #FF0000;">替您捐赠</span>229元仁和产品给福利院。（<span
