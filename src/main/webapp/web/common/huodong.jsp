        ...
        <section
            ...
            <p style="color: rgb(62, 62, 62);">
                                                                                            <span style="font-size: 15px;">1、顾客在活动门店购买<span
                                                                                                    ...
                                                                                                    style="color: #FF0000;">爱心公益价</span></strong>120元（<span
                                                                                                    style="color: #FF0000;">原价238元</span>），每人<span
                                                                                                    style="color: #FF0000;">限购3盒</span>。</span>
            </p>
            <p style="color: rgb(62, 62, 62);">
                                                                                            <span style="font-size: 15px;">2、您每消费120元，仁和康健就<span
                                                                                                    style="color: #FF0000;">替您捐赠</span>120元仁和产品给福利院。（<span
